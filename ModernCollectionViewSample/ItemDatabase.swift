    ...
    func getItemCollections() -> [ItemCollection] {
        [ItemCollection(title: "Popular Apps to Try",
         ...
         ItemCollection(title: "Apps for professionals",
                        ...
                        sectionKindId: 3),
         ItemCollection(title: "Add Widget to Your Home Screen",
                        items: [
                            ItemModel(iconName: "flow",
                                      title: "Flow by Moleskine Studio",
                                      subTitle: "Sketch. Think. Create."),
                            ItemModel(iconName: "autodesk",
                                      title: "Autodesk SketchBook",
                                      subTitle: "Draw, paint, & sketch anywhere"),
                            ItemModel(iconName: "yazio",
                                      title: "YAZIO Fasting & Food Tracker",
                                      subTitle: "Calorie Counter and Diet Diary"),
                            ItemModel(iconName: "relax",
                                      title: "Relax Melodies: Sleep Sounds",
                                      subTitle: "Meditation, Calm, White Noise"),
                            ItemModel(iconName: "dailyplanner",
                                      title: "Daily Planner- Habit Tracker",
                                      subTitle: "Goal tracker & To Do List"),
                            ItemModel(iconName: "wikipedia",
                                      title: "Wikipedia",
                                      subTitle: "The Free Encyclopedia"),
                            ItemModel(iconName: "facebook",
